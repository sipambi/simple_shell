...
/**
 * searchNode - searches linked lists for string and returns index
 * @head: pointer to head of the list
 * @str: input string
 * Return: index of node with matching string
 */
int searchNode(linked_1 *head, char *str)
{
...
/**
 * addNodeAtIndex - add more at index with string
 * @head: double pointer to head
 * @index: indexto add to
 * @str: string to add
